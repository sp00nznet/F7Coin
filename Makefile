#############################################################################
# Makefile for building: F7Coin-Qt.app/Contents/MacOS/F7Coin-Qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Sep 23 04:00:01 2014
# Project:  f7coin-qt.pro
# Template: app
# Command: /opt/local/bin/qmake USE_UPNP=- -o Makefile f7coin-qt.pro
#############################################################################
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		build/moc_verifymessagedialog.cpp \
...
OBJECTS       = build/macdockiconhandler.o \
		...
		build/moc_verifymessagedialog.o \
...
DIST          = /opt/local/share/qt4/mkspecs/common/unix.conf \
		...
		f7coin-qt.pro
QMAKE_TARGET  = F7Coin-Qt
DESTDIR       = 
TARGET        = F7Coin-Qt.app/Contents/MacOS/F7Coin-Qt
...
all: Makefile F7Coin-Qt.app/Contents/PkgInfo F7Coin-Qt.app/Contents/Resources/empty.lproj F7Coin-Qt.app/Contents/Info.plist F7Coin-Qt.app/Contents/Resources/bitcoin.icns $(TARGET)

$(TARGET): /Users/sp00nz/Desktop/F7Coin/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_messagepage.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_verifymessagedialog.h build/ui_miningpage.h build/ui_optionsdialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) F7Coin-Qt.app/Contents/MacOS/ || $(MKDIR) F7Coin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: f7coin-qt.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile f7coin-qt.pro
...
F7Coin-Qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) F7Coin-Qt.app/Contents || $(MKDIR) F7Coin-Qt.app/Contents 
	@$(DEL_FILE) F7Coin-Qt.app/Contents/PkgInfo
	@echo "APPL????" >F7Coin-Qt.app/Contents/PkgInfo
F7Coin-Qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) F7Coin-Qt.app/Contents/Resources || $(MKDIR) F7Coin-Qt.app/Contents/Resources 
	@touch F7Coin-Qt.app/Contents/Resources/empty.lproj
	
F7Coin-Qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) F7Coin-Qt.app/Contents || $(MKDIR) F7Coin-Qt.app/Contents 
	@$(DEL_FILE) F7Coin-Qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,0.6,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,bitcoin.icns,g" -e "s,@EXECUTABLE@,F7Coin-Qt,g" -e "s,@TYPEINFO@,????,g" /opt/local/share/qt4/mkspecs/macx-g++/Info.plist.app >F7Coin-Qt.app/Contents/Info.plist
F7Coin-Qt.app/Contents/Resources/bitcoin.icns: src/qt/res/icons/bitcoin.icns
	@$(CHK_DIR_EXISTS) F7Coin-Qt.app/Contents/Resources/ || $(MKDIR) F7Coin-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) F7Coin-Qt.app/Contents/Resources/bitcoin.icns
	@$(COPY_FILE) src/qt/res/icons/bitcoin.icns F7Coin-Qt.app/Contents/Resources/bitcoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/F7Coin-Qt0.6.3 || $(MKDIR) build/F7Coin-Qt0.6.3 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/F7Coin-Qt0.6.3/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/F7Coin-Qt0.6.3/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/F7Coin-Qt0.6.3/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/messagepage.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/uint256.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/qt/verifymessagedialog.h src/scrypt.h src/qt/miningpage.h src/version.h src/qt/macdockiconhandler.h build/F7Coin-Qt0.6.3/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/F7Coin-Qt0.6.3/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/messagepage.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/json/json_spirit_writer.cpp src/json/json_spirit_value.cpp src/json/json_spirit_reader.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/qt/verifymessagedialog.cpp src/scrypt.c src/qt/miningpage.cpp src/noui.cpp build/F7Coin-Qt0.6.3/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/F7Coin-Qt0.6.3/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/messagepage.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/verifymessagedialog.ui src/qt/forms/miningpage.ui src/qt/forms/optionsdialog.ui build/F7Coin-Qt0.6.3/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/F7Coin-Qt0.6.3/ && (cd `dirname build/F7Coin-Qt0.6.3` && $(TAR) F7Coin-Qt0.6.3.tar F7Coin-Qt0.6.3 && $(COMPRESS) F7Coin-Qt0.6.3.tar) && $(MOVE) `dirname build/F7Coin-Qt0.6.3`/F7Coin-Qt0.6.3.tar.gz . && $(DEL_FILE) -r build/F7Coin-Qt0.6.3
...
distclean: clean
	-$(DEL_FILE) -r F7Coin-Qt.app
	-$(DEL_FILE) Makefile


/Users/sp00nz/Desktop/F7Coin/build/build.h: FORCE
	cd /Users/sp00nz/Desktop/F7Coin; /bin/sh share/genbuild.sh /Users/sp00nz/Desktop/F7Coin/build/build.h
...
compiler_moc_header_make_all: build/moc_bitcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_addressbookpage.cpp build/moc_messagepage.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_bitcoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_bitcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_rpcconsole.cpp build/moc_verifymessagedialog.cpp build/moc_miningpage.cpp build/moc_macdockiconhandler.cpp
...
build/moc_messagepage.cpp: src/qt/messagepage.h
	/opt/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/messagepage.h -o build/moc_messagepage.cpp
...
build/moc_verifymessagedialog.cpp: src/qt/verifymessagedialog.h
	/opt/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/verifymessagedialog.h -o build/moc_verifymessagedialog.cpp
...
build/ui_messagepage.h: src/qt/forms/messagepage.ui \
	...
	/opt/local/bin/uic src/qt/forms/messagepage.ui -o build/ui_messagepage.h
...
build/ui_verifymessagedialog.h: src/qt/forms/verifymessagedialog.ui \
		src/qt/qvalidatedlineedit.h
	/opt/local/bin/uic src/qt/forms/verifymessagedialog.ui -o build/ui_verifymessagedialog.h
...
build/verifymessagedialog.o: src/qt/verifymessagedialog.cpp src/qt/verifymessagedialog.h \
		build/ui_verifymessagedialog.h \
		src/qt/qvalidatedlineedit.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/qt/guiutil.h \
		src/base58.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/verifymessagedialog.o src/qt/verifymessagedialog.cpp
...
build/moc_verifymessagedialog.o: build/moc_verifymessagedialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_verifymessagedialog.o build/moc_verifymessagedialog.cpp
